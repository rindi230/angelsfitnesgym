  ...
  return (
    <section id="gallery" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Galeria e palestres</h2>
        ...
        >
            ...
            <div className="relative">
              ...
              <div className="relative mx-auto max-w-sm">
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/70 text-white p-3 rounded-full hover:bg-black/90 transition-colors duration-300 z-10"
                >
                ...
                <button
                  onClick={goToNext}
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/70 text-white p-3 rounded-full hover:bg-black/90 transition-colors duration-300 z-10"
                >
          ...
          {/* Desktop Layout - Multiple Images */}
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      className="w-64 h-64 object-cover rounded-xl shadow-lg cursor-pointer border-4 border-white"
                    />
